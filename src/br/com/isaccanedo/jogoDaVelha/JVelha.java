 ...
 * Desenvolvido por: Isac Canedo
 * Ultima Modificacao: 31/07/2004
 */
 ...
 /*------------------------------------------------------------------------------------------------------*/
	...
	computador.setAccelerator(javax.swing.KeyStroke.getKeyStroke(java.awt.event.KeyEvent.VK_C, java.awt.event.InputEvent.CTRL_MASK));
        ...
        sobre.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent evt)
            {
                JOptionPane.showMessageDialog(null, "Copyright 2004, Isac Canedo", "Jogo da Velha", JOptionPane.INFORMATION_MESSAGE);
            }
        });
        setJMenuBar(mb);
